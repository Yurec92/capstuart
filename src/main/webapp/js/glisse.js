...
(function ($) {
    $.glisse = function (element, options) {
        ...
        var createElements = function createElements() {
			...
			plugin.els['controlNext'].hover(function(){$( this ).css( "opacity", 2 );},function() {$( this ).css( "opacity", 0.7 );}
					);		
			plugin.els['controlPrev'].hover(function(){$( this ).css( "opacity", 2 );},function() {$( this ).css( "opacity", 0.7 );}
					);	
